...
# load ##################################################################################################################
load(file = "path/constants_SC_fall.rda") # constants/data

load(file = "path/outcome_SC_fall.rda") # outcome

load(file = "path/inits_SC_fall.rda") # initial values
# &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
