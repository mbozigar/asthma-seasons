...
model.code<-nimbleCode({
  ...
  {	
    for (j in 1:4) # index case day (1) and control days (3)
    {
      ...
      dev[i,j] <- -2*LL[i,j] # for calculating DIC fit statistic
    }
...
# load ##################################################################################################################
load(file = "path/constants_SC_allseasons.rda") # constants/data

load(file = "path/outcome_SC_allseasons.rda") # outcome

load(file = "path/inits_SC_allseasons.rda") # initial values
# &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
